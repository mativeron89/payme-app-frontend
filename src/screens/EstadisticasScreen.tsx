...
export function EstadisticasScreen() {
  ...
  const cocina = categoryLabel(stats?.favorite_category);
  ...
  return (
    <div className="screen has-appbar">
      <AppHeaderBack title="Mis estadísticas" onBack={() => goBack('home')} />
      ...
      <div className="scroll" style={{ paddingLeft: 16, paddingRight: 16, paddingTop: 16 }}>
        {!vista.showAccountActivity ? (
          <div className="state-unknown">
            ...
            <div>
              <div className="state-unknown-title">No podemos mostrar tus estadísticas ahora</div>
          ...
          <div className="state-error">
            <div className="state-error-row">
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div className="state-error-title">No pudimos cargar tus estadísticas</div>
          ...
          <>
            {sinActividad ? (
              ...
              <div className="mesa-empty">
                <div className="mesa-empty-title">Todavía no registramos consumos este mes.</div>
              </div>
            ) : (
              <>
                {/* El ancla de la pantalla. */}
                <div className="stat-hero">
                  <div className="stat-hero-lbl">Este mes</div>
                ...
                <div className="stat-pair">
                  <div className="stat-cell">
                    ...
                    <div className="stat-lbl">Visitas</div>
                  </div>
                  <div className="stat-cell">
                    <div className="stat-num tabular">{pesos(stats.month.avg_per_visit_cents)}</div>
                    <div className="stat-lbl">Promedio por visita</div>
                  </div>
                </div>

                {stats.top_restaurants.length > 0 && (
                  <>
                    <h2 className="stat-sect">Tus restaurantes</h2>
                        ...
                        <div key={r.name} className="stat-rest">
                          <div className="stat-rest-top">
                            ...
                            <span className="stat-rest-visits">
                              {entero(r.visits)} {r.visits === 1 ? 'visita' : 'visitas'}
                            </span>
                          </div>
                ...
                {cocina && (
                  <>
                    <h2 className="stat-sect">Tipo de cocina favorito</h2>
            ...
            <div className="state-unknown" style={{ marginLeft: 0, marginRight: 0 }}>
              <Icon name="info" size={20} />
              <div>
                <div className="state-unknown-title">Todavía no existe en el contrato</div>
                <p className="state-unknown-body">
                  Comparación con el mes anterior · propinas acumuladas · ranking por tipología de
                  plato.
                </p>
              </div>
            </div>
