...
//
// 2026-09-19 (AF-32): se PRESENTA 2.5.3 (la foto de quienes se sumaron, sólo
// para el organizador y nunca de menores o sin fecha), aprobado por Mati
// (decisión `17d436dd…`). El dueño lo publica en `293dae75…` (rama local sin
// publicar). Mismo orden: el front va ANTES. Se AGREGA: 2.5.2 es lo que sirve
// producción hoy.
//
...
//
// 2026-09-24 (adenda a AF-LISTO-INICIO): se presentó 2.5.6 (notificaciones por
// correo). 2026-09-25 (ORDEN MAESTRA LEGAL-3.0.0, AF1): 2.5.6 NO se publica
// nunca —lo reemplaza el aviso integral 3.0.0 de la abogada (decisiones 46/47)—
// y se RETIRA de este set; se PRESENTA 3.0.0. Mismo orden que siempre: el front
// va ANTES que el dueño, porque si App Backend publicara `notice_version:
// '3.0.0'` sin esta línea, la edición de nombre y foto se apagaría con
// `notice_unavailable`. Se AGREGA: 2.5.5 es lo que sirve producción hoy.
const PRESENTABLE_NOTICE_VERSIONS = new Set<string>(['2.3.0', '2.4.1', '2.5.0', '2.5.1', '2.5.2', '2.5.3', '2.5.4', '2.5.5', '3.0.0']);
