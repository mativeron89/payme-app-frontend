...
| 🟡 **P0 contractual (G-11) · CIERRE REFUTADO, consumo PROVISIONAL** | El dueño publicó `7e45db0` (v2.46.0) declarando G-11 cerrado y este front lo consumió (`0d9c475`); **una auditoría externa refutó ese cierre el 2026-08-07: cinco huecos, el peor que la wallet nativa se adjuntaba a Stripe ANTES de validarla.** App Backend lo está reabriendo. El consumo NO se revierte —espejó y consumió correctamente lo publicado— pero **no se declara cerrado**: espera el hash bueno para un follow-up. | Follow-up cuando el dueño publique el cierre real. |
