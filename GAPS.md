...
| ✅ ~~P0 contractual (G-11)~~ **CERRADO (2026-08-07, backend v2.46.0 `7e45db0`)** | El guardado bajo direct charge es REAL: attach del pm_ fuente al Customer de PayMe tras el éxito (sync o webhook post-3DS), misma semántica que el vault. El front consumió el cierre: checkbox sigue desmarcado (decisión de Mati, sobrevive), opt-in guarda de verdad, workarounds del vault retirados, mock alineado y acreditado. | — |
